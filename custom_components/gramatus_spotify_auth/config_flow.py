"""Config flow for Gramatus Spotify Auth."""
...
class GramatusAuthFlowHandler(
    ...
    async def async_oauth_create_entry(self, data: dict[str, Any]) -> FlowResult:
        """Create an entry for Gramatus Spotify Auth."""
        self.logger.info("Creating auth entry for Gramatus Spotify Auth")
